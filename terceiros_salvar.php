...
$ts -> inserir_terceiros($conn, $terceiro->getCpf_cnpj(), $terceiro->getNome_razao_social(), $terceiro->getTelefone(), $terceiro->getE_mail());
header("Location: terceiros_form.php?resposta=Cadastrado com Sucesso&situacao=alert alert-success")
