...
<html lang="en">
    ...
    ?>
                           <form id="reused_form" method="POST" action="aluno_salvar.php">
                                    <div class="form-group">
                                        <label >Id_terceiros</label>
                                        <input type="text" name="id_terceiros" required class="form-control" placeholder="Enter Id_terceiros">
                                    </div>
                                    <div class="form-group">
                                        <label >Id_turma</label>
                                        <input type="text" name="id_turma" required class="form-control" placeholder="Enter id_turma">
                                    </div>
                                    <div class="form-group">
