...
<html lang="en">
    ...
    ?>
                                <form id="reused_form" method="POST" action="funcionario_salvar.php">
                                    <div class="form-group">
                                        <label >Data_admissao</label>
                                        <input type="text" name="data_admissao" required class="form-control" placeholder="Enter 0000-00-00">
                                    </div>
                                    <div class="form-group">
                                        <label >Data_demissao</label>
                                        <input type="text" name="data_demissao" required class="form-control" placeholder="Enter 0000-00-00">
                                    </div>
                                     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id_cargo" required class="form-control" placeholder="Enter Id_cargo">
                                    </div>
                                    <div class="form-group">
