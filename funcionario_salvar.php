...
$fs -> inserir_funcionario($conn, $func->getData_admissao(), $func->getData_demissao(), $func->getId_terceiro(), $func->getId_cargo());
header("Location: funcionario_form.php?resposta=Cadastrado com Sucesso&situacao=alert alert-success")
